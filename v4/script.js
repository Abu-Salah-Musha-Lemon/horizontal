/* ════════════════════════════════════════════════════════════
   ...
   Same horizontal-scroll mechanism on every device.
   ════════════════════════════════════════════════════════════ */
...
/* ✏️ EDIT: fill in real project details */
const PROJECTS = {
  swapnolok: {
    tag: 'Brand Identity',
  ...
  pipeline: {
    ...
    desc: 'A custom Python video pipeline with a stage-based architecture and interactive transition selector. Includes shredder_twirl, a CapCut-accurate venetian-blind strip-flip effect, and glitch_flash, an RGB-split chromatic aberration transition.'
  },
  carousel: {
    tag: 'Social Media',
  ...
  cleanup: {
    ...
    desc: 'A two-phase batch script with a registry-based auto-resume-after-reboot architecture, DISM/SFC handling, timestamped logging, and silent disk cleanup across 22 categories.'
  }
};
...
/* ✏️ EDIT: connect to Formspree / EmailJS / Netlify */
